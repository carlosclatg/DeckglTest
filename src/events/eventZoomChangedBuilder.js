...
export default function eventZoomChangedBuilder(viewPort){
    ...
    return new CustomEvent("topogisevt_map_zoom_changed",  { bubbles: true, cancelable: true, composed: true, detail:{zoom: Math.round(viewPort.zoom), west, north, east, south }});
}